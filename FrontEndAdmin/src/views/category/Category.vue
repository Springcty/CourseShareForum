...
<template>
  <el-card class="main-card">
    ...
    >
      ...
      <!-- 文章量 -->
      <el-table-column prop="categoryCount" label="文章量" align="center" />
      <!-- 分类创建时间
  ...
  methods: {
    ...
    openModel(category) {
      if (category != null) {
        ...
        delete this.categoryForm.categoryCount;
    ...
    addOrEditCategory() {
      ...
      this.axios
        .post(
          "http://101.37.254.247:9001/categories/admin/updateOrInsert",
          this.categoryForm
        )
        .then(({ data }) => {
          if (data.flag) {

...
<template>
  <div>
    <el-table-column label="书籍图片" width="160" align="center">
    </el-table-column>
    <!-- 统计数据 -->
    <el-row :gutter="30">
      <el-col :span="8">
...
export default {
  ...
  methods: {
    getData() {
      this.axios
        .get("http://101.37.254.247:9001/admin/articles/blogInfo")
        .then(({ data }) => {
          ...
          if (data.data.labelList != null) {
            data.data.labelList.forEach(item => {

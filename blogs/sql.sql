...
PRIMARY KEY (id)
-- FOREIGN KEY (author_id) REFERENCES users(id) #用户与文章存在一对多关系
);
...
PRIMARY KEY (id)
-- FOREIGN KEY (followed_id) REFERENCES users(id), #用户与用户存在多对多关系
-- FOREIGN KEY (follower_id) REFERENCES users(id) #用户与用户存在多对多关系
);
